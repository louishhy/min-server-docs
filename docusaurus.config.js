...
const config = {
  ...
  organizationName: 'louishhy', // Usually your GitHub org/user name.
  projectName: 'min-server-docs', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/louishhy/min-server-docs/tree/main',
        },
        blog: false,
        theme: {
